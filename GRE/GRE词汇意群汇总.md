...
attic [] n.阁楼，顶楼（a low story or wall above the main order of a facade in the classical styles）
...
obnoxious [əb'nɑkʃəs] adj.令人不愉快的，可憎的（）
...
daunt [] v.使胆怯，使畏缩（dauntless ['dɔntləs] adj.勇敢的）
...
aromatic [ˌærə'mætɪk] adj.芳香的（of, relating to, or having aroma: fragrant）
...
infiltrate [ɪn'fɪltret] v.渗透，渗入（to cause（as a liquid）to permeate something by penetrating its pores or interstices）
...
hypodermic [ˌhaɪpə'dəmɪk] adj.皮下注射的（）
...
clamorous [] adj.吵闹的，喧哗的（）/ˈklæmərəs/
...
ursine [] adj.熊的，像熊的（of or relating to a bear or the bear family）
...
kleptomania ['klɛptə'menɪə] n.燎择（a persistent neurotic impulse to steal especially without economic motive）
...
rostrum ['rɔstrəm] n.讲坛（A rostrum is a raised platform on which someone stands when they are speaking to an audience, receiving a prize, or conducting an orchestra.）

elocution [] n.演说术（Elocution lessons are lessons in which someone is taught to speak clearly and in an accent that is considered to be standard and acceptable.）

eloquent [] adj.雄辩的，演说动人的（）

extemporize [] v.即席演说（If you extemporize, you speak, act, or perform something immediately, without rehearsing or preparing it beforehand.）

heroics [hɪˈroɪks] n.装腔作势的演说或行为（dangerous or silly actions that are only done to make other people admire you）

monologue [ˈmɑnəˌlɔɡ] n.独白，个人长篇演说（A monologue is a long speech which is spoken by one person as an entertainment, or as part of an entertainment such as a play.）

screed [skrid] n.冗长的演说，长篇大论的文章（a lengthy discourse）

diatribe ['daɪətraɪb] n.（口头或书面猛烈的）抨击，抨击性演说（A diatribe is an angry speech or article which is extremely critical of someone's ideas or activities.）

harangue [hə'ræŋ] n.长篇演说（If someone harangues you, they try to persuade you to accept their opinions or ideas in a forceful way.）

tirade ['taɪred] n.长篇的攻击性演说（A tirade is a long angry speech in which someone criticizes a person or thing.）

valediction [] n.告别演说，告别词（）

talkathon ['tɔkəθɑn] n.冗长的讨论或演说（a long session of discussion or speech-making）
...
campestral [] adj.田野的，农村的（）

paysage [] n.乡村景色，风景（）

pastoral [] adj.田园生活的，宁静的（）

eclogue [ˈɛkˌlɔɡ] n.田园诗，牧歌（a poem in which shepherds converse）

idyll [ˈaɪdl] n.田园生活，田园诗（a simple descriptive work in poetry or prose that deals with rustic life or pastoral scenes or suggests a mood of peace and contentment）

idyllic [aɪ'dɪlɪk] adj.田园诗的（If you describe something as idyllic, you mean that it is extremely pleasant, simple, and peaceful without any difficulties or dangers.）

madrigal [] n.合唱曲，情诗，牧歌（）

boor [bʊr] n.举止粗野的人，乡下人（If you refer to someone as a boor, you think their behaviour and attitudes are rough, uneducated, and rude.）

corny ['kɔrni] adj.平谈无奇的，乡巴佬的（If you describe something as corny, you mean that it is obvious or sentimental and not at all original.）
...
cleaver ['klivɚ] n.切肉刀（one that cleaves; especially: a butcher's implement for cutting animal carcasses into joints or pieces）
...
pharisaic [ˌfæri'seiik] adj.伪善的，伪装虔诚的（pharisaical; marked by hypocritical censorious self-righteousness）

sanctimonious [ˌsæŋktɪ'monɪəs] adj.伪装虔诚的（If you say that someone is sanctimonious, you disapprove of them because you think that they are trying to appear morally better than other people.）

hypocrite ['hɪpə'krɪt] n.伪君子，伪善者（If you accuse someone of being a hypocrite, you mean that they pretend to have qualities, beliefs, or feelings that they do not really have.）

hypocritical [ˌhɪpə'krɪtɪkl] adj.伪善的，伪善者的（If you accuse someone of being hypocritical, you mean that they pretend to have qualities, beliefs, or feelings that they do not really have.）

hypocrisy [hɪ'pɑkrəsi] n.伪善，造作（If you accuse someone of hypocrisy, you mean that they pretend to have qualities, beliefs, or feelings that they do not really have.）

prudery ['prudəri] n.过分守礼，假正经（Prudery is prudish behaviour or attitudes. prude: one who is excessively concerned with being or appearing to be proper, modest, or righteous.）

prudish ['prudɪʃ] adj.过分守礼的，假道学的（Marked by or exhibiting the characteristics of a prude: priggish）
...
acting [] n.演戏，行为，假装a 代理的，临时的，演出用的（）
...
colt [kolt] n.小雄驹（A colt is a young male horse.）

coltish ['koltɪʃ] adj.放浪不拘的，似小马的（A young person or animal that is coltish is full of energy but clumsy or awkward, because they lack physical skill or control.）
...
nestling ['nɛstlɪŋ] n.尚未离巢的小鸟（A nestling is a young bird that has not yet learned to fly.）
...
lupine [] adj.狼的，残忍的，贪吃的（）

ruthless [] adj.无情的，残忍的，毫不留情的（）

satanic [] adj.穷凶极恶的（）

savage [] adj.凶猛的，野蛮的（）

raptorial [] adj.食肉的，凶猛的（）
...
nettle ['nɛtl] n.荨麻v.烦忧，激恼（If you are nettled by something, you are annoyed or offended by it.）
...
sabotage [ˌsæbə'tɑʒ] n.阴谋破坏，颠覆活动（If a machine, railway line, or bridge is sabotaged, it is deliberately damaged or destroyed, for example in a war or as a protest.）
...
hubbub ['hʌbʌb] n.嘈杂，喧哗（A hubbub is a noise made by a lot of people all talking or shouting at the same time.）
...
indecency [] n.无礼，不体面，猥亵（）

insult [] n.侮辱，无礼v.傲慢无礼，侮辱，刺激（）

asperity [] n.粗鲁，艰苦（）

crude [] adj.未提炼的，粗鲁的n.原油（）
...
earthy [] adj.粗俗不雅的，粗鲁的（）

crass [] adj.粗鲁的，愚钝的，粗糙的，非常的（）
...
stubborn [] adj.顽固的，不听话的，执拗的，棘手的（）

wrongheaded [] adj.乖僻的，顽固的，固执的，坚持错误的（）

froward [] adj.顽固的，固执的，刚愎的（）
...
monomania [ˌmɑnəˈmeniə] n.对一事的热狂，偏执狂（1. mental illness especially when limited in expression to one idea or area of thought; 2. excessive concentration on a single object or idea）
...
phraseologist [] n.爱用陈腐词藻的人（）

cliche [] n.虑焕牡鱝 陈腐的（）

slick [] adj.光滑的，熟练的，陈腐的（）
...
ravine [rə'vin] n.深谷，峡谷（a small narrow steep-sided valley that is larger than a gully and smaller than a canyon and that is usually worn by running water）

barranca [] n.峡谷（）

arroyo [] n.枯干的河道，峡谷，小河（）
...
nonchalance [] n.无动于衷，冷淡（the quality or state of being nonchalant）

nonchalant [] adj.冷漠的，满不在乎的（having an air of easy unconcern or indifference）

phlegmatic [] adj.冷静的，冷淡的（）

snub [] v.冷落，不理睬（）

pococurante [] adj.冷漠的，无动于衷的（）

offish [] adj.冷淡的（）

standoffish [] adj.有点不友好的，冷淡的（）

clammy [] adj.冷淡的，冷湿的，发粘的（）

indifferent [] adj.不感兴趣的，漠不关心的（）

insouciance [ɪn'susɪəns] n.漠不关心（lighthearted unconcern: nonchalance）
...
contained [] adj.抑制的，自制的，沉着的，冷静的（）

imperturbability [] n.沉着，冷静，自若（）

sedate [] adj.安静的，镇静的（）

selfcollected [] adj.镇定的（）

unflappable [] adj.镇定的，从容不迫的（）

demulcent [] adj.缓和的，镇静的（）
...
underage [] n.缺乏，不足adj.未成年的（）

dearth [] n.缺乏，粮食不足，饥谨（）/dɜːθ/
...
begrudge [] v.吝啬，勉强给（to give or concede reluctantly or with displeasure; begrudge money; begrudged the weeks spent away from home）
...
pungent [] adj.刺鼻的，苛刻的（Something that is pungent has a strong, sharp smell or taste which is often so strong that it is unpleasant.）
...
celibate ['sɛlɪbət] n./adj.独身者，不结婚的（）
...
deliberate [] adj.深思熟虑的v.慎重考虑（）

pensive [] adj.沉思的，愁眉苦脸的（）

reflective [] adj.深思熟虑的（）

ruminant [ˈrumənənt] adj.（动物）反刍的，沉思的（given to or engaged in contemplation: meditative; stood there…in this attitude of ruminant relish）
...
roe [] n.鱼卵（Roe is the eggs or sperm of a fish, which is eaten as food.）

spawn [] n.（鱼等）卵子v.大量产卵，大量生产（）
...
asphyxiate [əs'fɪksɪet] v.（使）无法呼吸，窒息而死（）
...
calculated [] adj.有计划的，适当的，适合的，计算出的（）
...
sport [spɔrt] v.炫耀，卖弄（to display or wear usually ostentatiously: boast; sporting expensive new shoes）
...
buck [] v.强烈反对，吹牛n.雄鹿，美元（）

thrasonical [] adj.自负的，吹牛的（）

braggart [] n.吹牛大王（）

astrut [] adj./adv.趾高气扬的/地（）
...
dismal [] adj.阴沉的，凄凉的，暗的n 低落的情绪，沼泽（）

Stygian ['stɪdʒɪən] adj.地狱的，冥府的，阴间的，阴森森的，黑暗的（1. of or relating to the river Styx; 2. extremely dark, gloomy, or forbidding; the stygian blackness of the cave; Styx [stiks] n.冥河the principal river of the underworld in Greek mythology）
...
pang [] n.剧痛，悲痛，苦闷v.使剧痛，折磨（）

bewail [] v.悲悼，哀泣，叹惜（）

bitterness [] n.苦味，悲痛，怨恨（）

atrabilious [] adj.沉闷的，忧郁的（）

dirge [] n.哀歌，凄凉之曲调（）

elegy [] n.哀歌，挽歌（）

elegiac [] n.哀歌，挽歌a 哀歌体的，挽歌的（）
...
incline [] n. 斜坡 [] v.倾斜，爱好（）

inclined [] adj.倾向于，赞成的（）
...
neophyte ['niəfaɪt] n.初学者，新手（）

novice [] n.生手，新手（）

tyro ['taɪro] n.新手（）

tenderfoot [ˈtɛndɚˌfʊt] n.生手，新手（an inexperienced beginner: novice; a political tenderfoot）
...
dopey [] adj.头脑糊涂的，呆笨的，迟钝的（）

blundering [] adj.浮躁的，粗笨的，易犯错的（）
...
moron [] n.极蠢之人，低能儿（1. usually offensive: a person affected with mild mental retardation; 2. a very stupid person）
...
nincompoop [] n.无用的人，傻子（）

doodle [] v.涂鸦，混时间n 傻子（）

oafish [] adj.呆子的，白痴的（）

mongolism [] n.先天白痴（usually offensive: down syndrome）

cretin ['kritn] n.白痴（a stupid, vulgar, or insensitive person: clod, lout）
...
versant [] adj.专心从事的n 斜坡（）

gradient [] n.斜坡，坡度（）

grade [] n.等级，斜坡，坡度，程度v.分等，分级，评分（）

tippy [] adj.倾斜的，不安定的（小船等）（）
...
cronyism [] n.任用亲信，对好朋友的偏袒（）

nepotism [] n.裙带关系（）

preoccupation [] n.先取，先入成见，偏见，出神（）

hidebound [] adj.顽固的，心胸狭窄的（）

illiberal [] adj.气量狭窄的，吝啬的（）

insular [] adj.岛屿的，心胸狭窄的（characteristic of an isolated people; especially: being, having, or reflecting a narrow provincial viewpoint）
...
clique [] n.朋党派系，小集团（If you describe a group of people as a clique, you mean that they spend a lot of time together and seem unfriendly towards people who are not in the group.）
...
sectarianism [] n.宗派心，派系意识[主义]，门户之见（）
...
lynxeyed adj目光锐利的，眼力好的（）

accipitral [] adj.鹰的，贪婪的，目光锐利的（）/æk'sipitrəl/
...
buoy [] n.浮标，救生圈v.支持，鼓励（）

foster [] v.养育，抚育，抱（希望），鼓励，培养（）
...
consortium [kən'sɔrtɪəm] n.协会，公会，国际资本家联合（an agreement, combination, or group（as of companies）formed to undertake an enterprise beyond the resources of any one member）

cartel [] n.企业联合，俘虏交换条约，决斗挑战书（）

pastiche [] n.（音乐等）混合作品（）

miscible [] adj.易混合的（）

syncretize [] v.（使）结合，（使）调和（）

potpourri [] n.混杂，杂文集（）

admix [] v.混合，掺合（）

fusion [] n.熔合物，结合，熔合，核聚变（）
...
eclectic [] adj.折衷的，综合性的（）

synthetic [] adj.综合的，人造的（）

colligate [] v.绑，束，缚，综合，概括（）
...
adynamic [] adj.衰弱的，无力的（）

emasculate [] v.阉割，使…无力（）

impuissance [] n.无能，无力，虚弱（）
...
synopsis [sɪ'nɑpsɪs] n.摘要，概要（A synopsis is a summary of a longer piece of writing or work.）

synoptic [] adj.摘要的，高瞻远瞩的（）

precis [] n.摘要，大纲（）/ˈpre'si/

syllabus [] n.教学纲要（）

outline [] n.大纲，轮廓，概要（）

prospectus [] n.章程，内容简介（）
...
schematic [] adj.扼要的，图解的（A schematic diagram or picture shows something in a simple way.）/ski'mætɪk/
...
dispatch [] v.派遣，一下子做完，吃完n.迅速（）

lope [] n.轻快的步伐v.轻快地迈着大步（）
...
sprint [] n.全速奔跑（to run or go at top speed especially for a short distance）

whoosh [] v.飞快的移动，发出咝咝声（）

gallop [] n./v.（马）飞奔，疾驰（to run fast）

bolt [] n.螺栓，门栓 [] v.急逃，脱离（to move or proceed rapidly: dash）
...
mollycoddle [] v.过份爱惜，娇惯n.娇生惯养的人（）

cocker [] v.娇养，溺爱，放纵（）

coddle [] v.娇养，溺爱n.娇生惯养的人（）

cosset [] n.亲手饲养的小动物，宠儿v.宠爱，珍爱，溺爱（）
...
counterargument [] n.驳论; 抗辩（）

还有deny, disprove, contradict

秘密的，神秘的

arcane [ɑr'ken] adj.神秘的，秘密的（known or knowable only to the initiate: secret; arcane rites; broadly: mysterious, obscure; arcane explanations）
...
runic [] adj.古代北欧文字的，有神秘性的（）

unearthly [] adj.非尘世的，神秘的，怪异的（）
...
fret [] v./n.（使）烦躁，焦虑（If you fret about something, you worry about it.）

fretful [] adj.烦躁的（disposed to fret: irritable, restless）
...
checkered [] adj.方格花样的;富于变化的，多浮沉的（）

labile [] adj.不安定的，易发生变化的（）

quirky [] adj.剧变的，反复无常的，任性的（）

Protean [] adj.千变万化的，变化不定的（）
...
peddling [] adj.琐碎的，细小的（）

inconsequential [] adj.不重要的，微不足道的（）

paltry [] adj.无价值的，微不足道的（）

picayunish [] adj.微不足道的，不值钱的（）

trashy [] adj.碎屑的，没用的，垃圾似的（）
...
bagatelle [] n.小事，琐事（trifle: something of little value, substance, or importance）

trivia [] n.琐事，无价值之物（）

trifle [] n.微不足道，琐事（something of little value, substance, or importance）
...
good-natured [] adj.性情好，温和的，好脾气的，和善的（）
...
simpatio [] adj.可爱的，和谐的（）

agreeable [] adj.愉快的，和蔼可亲的，同意的（）
...
devout [] adj.虔诚的，虔敬的，衷心的（）

honor [] v.尊敬，授予荣誉，承兑，实践（）
...
glorify [] v.赞美，美化，赞扬，够曰（）

bless [] v.祝福，颂扬（）

eulogistic [] adj.颂扬的，歌功颂德的（）

carol [] n.赞美诗，颂歌（a song of joy or mirth; the carol of a bird）

encomium [] n.赞颂，颂辞（）

eulogy [] n.颂词，颂文（）

ode [] n.长诗，颂歌（a lyric poem usually marked by exaltation of feeling and style, varying length of line, and complexity of stanza forms）

paean [] n.赞美歌，颂歌（）

panegyric [ˌpænəˈdʒɪrɪk] n.颂词，颂扬（a eulogistic oration or writing; also: formal or elaborate praise）
...
indecisive [] adj.非决定性的，犹豫不决的，不明确的（）

irresolute [] adj.无决断的，优柔寡断的，踌躇不定的（）
...
falter [] v.支吾地说，迟疑n.颤抖，支吾，踌躇（）

discredit [] v.怀疑n.丧失名誉（）
...
dubiety [] n.可疑性，怀疑，可疑的东西（）

misgiving [] n.[对有关未来之事的]不安，疑惑，忧虑，缺乏信心（）
...
tramp [] v.重步走，（to walk, tread, or step especially heavily）

trek [] n./v.（徒步）艰难旅行，跋涉，远足（If you trek somewhere, you go on a journey across difficult country, usually on foot）
...
prostrate [] v.平放，征服，使…衰弱adj.俯卧的，屈服的（）

thewless [] adj.体力虚弱的（）

impuissance [] n.无能，无力，虚弱（）

infirm [] adj.弱的，虚弱的，柔弱的（）
...
discard [] v.丢弃，抛弃，解雇，垫牌n 垫牌，抛弃（）

spurn [] v.拒绝，摒弃（to reject with disdain or contempt: scorn）
...
immediacy [] n.立即，刻不容缓（the quality or state of being immediate）
...
whim [] n.多变，怪念头（A whim is a wish to do or have something which seems to have no serious reason or purpose behind it, and often occurs suddenly.）
...
idiosyncrasy [] n.特殊癖性或行为（If you talk about the idiosyncrasies of someone or something, you are referring to their rather unusual habits or characteristics.）/ˌɪdɪə'sɪŋkrəsi/
...
maverick [] n.独行者，想法与众不同的人（If you describe someone as a maverick, you mean that they are unconventional and independent, and do not think or behave in the same way as other people.）/'mævərɪk/

世俗的，超俗的

mundane [] adj.现世的，世俗的（of, relating to, or characteristic of the world; 2. characterized by the practical, transitory, and ordinary: commonplace; the mundane concerns of day-to-day life）/mʌnˈden/

secular [] adj.世俗的，尘世的（You use secular to describe things that have no connection with religion.）

temporal [] adj.时间的，世俗的（Temporal powers or matters relate to ordinary institutions and activities rather than to religious or spiritual ones.）

subcelestial [] adj.世俗的，尘世的（mundane）
...
limbo [] n.不稳定，中间状态（If you say that someone or something is in limbo, you mean that they are in a situation where they seem to be caught between two stages and it is unclear what will happen next.）
...
arabesque [] n.蔓藤图饰（an ornament or style that employs flower, foliage, or fruit and sometimes animal and figural outlines to produce an intricate pattern of interlaced lines）/ˌærə'bɛsk/
...
prink [] v.装饰，打扮，用嘴喙理（羽毛）（）

preen [] v.整理羽毛，（人）打扮修饰（）

clinquant [] adj.装饰得金光闪闪的n.仿金箔（）

wainscot [] n.护壁板adj.用…装饰（）

inlaid [] adj.嵌入的，镶嵌的，镶饰的（）

enamel [] n.珐琅，瓷釉 [] v.涂以瓷釉，彩饰（）

vignette [] n.小装饰图案，小品文（）
...
sinkhole [] n.阴沟的入口处，排水口，污水坑（）

contaminate vt 弄污，弄脏，毒害，传染，染污（）

outfall [] n.阴沟的入口处，排水口，污水坑（）
...
sleek [] v.（使）光滑adj.光滑的，整洁的（）

spruce [] n.云杉adj.整洁的，潇洒的（）
...
purgatory [] n.灵魂的净化，涤罪，炼狱a 涤罪的（）

sublimate [] v.（使）升华，净化（）

清澈，透明

diaphanous [daɪ'æfənəs] adj.（布）精致的，半透明的（）
...
manifest [] adj.明白的v.载货清单（）

manifestation [] n.显示，证明，示威运动（）

elaborate [] v.详尽地说明，阐明（）
...
nonage [] n.青年期，早期（a period of youth）
...
archaic [] adj.已废的，古老的，古代的（）

archaism [] n.古语，古体，拟古主义（）
...
royalty [] n.皇室，版税（付给著作人的钱）（）

tariff [] n.关税，价目表（）

collect [] v.收（租，税，帐等）（）

impost [] n.税款，关税v.决定关税，分类课税（）
...
bustling [] adj.忙碌的，活跃的（）

tuck [] v.卷起，隐藏n.缝褶，活力adj.忙碌的，活跃的（）
...
invigoration [] n.精神充沛，身心愉快，鼓舞（）

verve [] n.（艺术作品的）神韵，（人）生机，精力（）
...
exhilarating [] adj.使人兴奋的（）

hilarious [] adj.充满欢乐的，引起大笑的（）
...
conviviality [] n.宴乐，欢乐，高兴（）

convivial [] adj.欢乐的，狂欢的（）

jovial [] adj.快活的，高兴的，愉快的，朱庇特的（）

lighthearted [] adj.轻松的，快活的，爽朗的，兴高采烈的（）
...
moan [] v./n.（痛苦的）呻吟，（不满的）抱怨（）

repine [] v.不满，心中抱怨（）

disgruntled [] adj.心境不佳的，不满的（）
...
banter [] n.戏谑，嘲弄v戏弄，开玩笑（）

娱乐，休息

frisk [] n./v.蹦跳，娱乐；搜身（to leap, skip, or dance in a lively or playful way: gambol; to search（a person）for something（as a concealed weapon）by running the hand rapidly over the clothing and through the pockets）
...
loll [lɑl] v.懒洋洋地坐或卧（to act or move in a lax, lazy, or indolent manner: lounge）
...
gropingly [] adv.不确定的，摸索的（）

scour [] v.四处搜索（）

trawl [] n.拖网v.用拖网捕鱼，搜罗（）
...
corrigendum [] n.应改正的错误，正误表（）

balk [] n.障碍，错误，失败（）

erroneous [] adj.错误的，不正确的（）

unsound [] adj.不健全的，有病的，不可靠的，错误的，腐烂的（）
...
withhold [] v.扣留，保留，抑制，忍住（）

curb [] n.马勒v.控制（）

regiment [] n.（军队）团v.严格控制（）
...
commission [] n.委任状，命令，委托，犯法v.委任，使服役（）
...
protuberance [pro'tubərəns] n.节疤，突出，凸出（A protuberance is a rounded part that sticks out from the surface of something.）
...
convex ['kɑnvɛks] adj.凸出的（Convex is used to describe something that curves outwards in the middle.）
...
concave [] adj.凹的（A surface that is concave curves inwards in the middle.）/kɑn'kev/
...
competent [] adj.能干的，胜任的，有权能的，足够的（）
...
moderate [] adj.不过份的，有节制的 [] v.减轻，节制（）
...
filings [] n.锉屑（Filings are very small pieces of a substance, especially a metal, that are produced when it is filed or cut.）/'faɪlɪŋz/
...
shred [] v.切成细条，撕成碎片n 碎片，碎条（）

scree [] n.山坡上的碎石堆（）

spall [] n.裂片，碎片（尤指石头）（）

macadam [] n.（铺路用的）碎石，碎石路（macadamized roadway or pavement especially with a bituminous binder）/mə'kædəm/

tatter [] v.撕碎n 碎片（）

smithereens [] n.碎片，毁灭（）

clout [] n.破布，碎片布（）/klaʊt/

flotsam [] n.浮货，废料，零碎（）

弄碎

asunder [] adv.分离，化为碎片（）/əˈsʌndɚ/
...
brittle [] adj.易碎的，脆弱的，易坏的（）

brittleness [] n.脆度; 脆碎性; 脆性; 易碎性（）
...
intricate [] adj.复杂难懂的（You use intricate to describe something that has many small parts or details.）
...
lingo ['lɪŋgo] n.难懂的方言，隐语（strange or incomprehensible language or speech）

convoluted ['kɑnvəlutɪd] adj.旋绕的，费解的（）
...
obscure [] adj.难解的，不清楚的v.隐藏，使…模糊（）

obscurity [] n.费解，不出名（）

tenebrous [] adj.黑暗的，难解的（）

unintelligible [] adj.无法了解的，难解的，莫明其妙的（）

nodus ['nodəs] n.难点，错综复杂（complication, difficulty）

esoteric [] adj.秘传的，神秘的（requiring or exhibiting knowledge that is restricted to a small group; esoteric terminology; broadly: difficult to understand）
...
viscosity [] n.粘度，粘性（Viscosity is the quality that some liquids have of being thick and sticky.）/vɪs'kɑsəti/

viscous ['vɪskəs] adj.粘的（A viscous liquid is thick and sticky.）
...
glabrous [] adj.光洁的，无毛的（having a surface without hairs or projections; glabrous skin, glabrous leaves）
...
grease [] n.兽脂，油脂，贿赂v.涂脂于，贿赂（）

tanker [] n.油轮，运油船，加油飞机，油罐汽车（）

unctuous [] adj.颓 滑调的（）

oleaginous [] adj.油腻的，圆滑的，满口恭维的（）
...
cognomen [kɑɡˈnomən] n.姓（）

compellation [] n.姓名，头衔（）

incognito [ˌɪnkɑɡ'nito] adj./n.隐姓埋名的，化名（）

alias ['elɪəs]n.化名，别名（An alias is a false name, especially one used by a criminal.）
...
epithet [] n.（贬低人的）短语或形容词，绰号（）

标点符号

apostrophe [ə'pɑstrəfi] n.书写中撇号（’）（表示省略或所有格）（the addressing of a usually absent person or a usually personified thing rhetorically）

caret ['kærət] n.加字符号（∨，∧）（a wedge-shaped mark made on written or printed matter to indicate the place where something is to be inserted）

hyphen [] n.连字号，即“—”（a punctuation mark - used especially to divide or to compound words, word elements, or numbers）

period [] n.句号（a point . used to mark the end（as of a declarative sentence or an abbreviation））

colon ['kolən] n.冒号（A colon is the punctuation mark : which you can use in several ways. For example, you can put it before a list of things or before reported speech.）
...
question mark [] n.问号（a mark ? used in writing and printing at the conclusion of a sentence to indicate a direct question）

exclamation point [] n.感叹号（a mark ! used especially after an interjection or exclamation to indicate forceful utterance or strong feeling）

dash [] n.破折号（A dash is a straight, horizontal line used in writing, for example to separate two main clauses whose meanings are closely connected.）

quotation marks [] n.引号（quote marks）

brace [] n.大括号（Braces or curly braces are a pair of written marks that you place around words, numbers, or parts of a computer code, for example to indicate that they are connected in some way or are separate from other parts of the writing or code.）

slash [] n.斜杠（You say slash to refer to a sloping line that separates letters, words, or numbers. For example, if you are giving the number 340/2/K you say 'Three four zero, slash two, slash K.'）

asterisk ['æstərɪsk] n.星号（the character * used in printing or writing as a reference mark, as an indication of the omission of letters or words, to denote a hypothetical or unattested linguistic form, or for various arbitrary meanings）

过分，过度

egregious [ɪˈɡridʒəs] adj.（缺点等）过份的，惊人的（Egregious means very bad indeed）
...
immoderate [] adj.无节制的，过度的（If you describe something as immoderate, you disapprove of it because it is too extreme.）/ɪ'mɑdərət/
...
matriculation [mə,trikju'leiʃən] n.大学入学许可，入学，入学考试（[formal] the act of officially becoming a student at a university）

粗糙的

crude [krud] adj.未提炼的，粗鲁的n.原油（existing in a natural state and unaltered by cooking or processing: crude oil）
...
homespun [] adj.[布]手织的，朴素的，粗糙的，平凡的（）
...
saccharin ['sækərɪn] n.糖精（Saccharin is a very sweet chemical substance that some people use instead of sugar, especially when they are trying to lose weight.）

gimmick ['ɡɪmɪk] n.吸引人的花招，噱头（）
...
posturer [] n.装横作样者，摆姿势者（）

mincing [] adj.矫饰的，装腔作势的，装模作样的，切碎的（）

gentility [] n.假充上流，假装文雅; 假派头（）

自然，自发

artless [] adj.粗俗的，自然的（Someone who is artless is simple and honest, and does not think of deceiving other people.）
...
involuntary [] adj.自然而然的，无意识的，不知不觉的（）

outgrowth [] n.自然的发展，结果，副产物（）

unassuming [] adj.不摆架子的，不造作的（）

unstudied [] adj.不造作的，优雅的（）

unliterary [] adj.不矫糅造作的，不咬文嚼字的（）

苦干，研究，勤勉

drudge [] v.劳碌，做苦差事n.劳碌的人（）

fag [] v.苦干n.苦工（to work hard: toil）
...
painstaking [] n.辛苦，苦心，工夫a 辛苦的，勤勉的，小心的（）
...
asseverate [] v.郑重声明，断言（）

allege vt 宣称，申述，主张，断言（）

protestation [] n.主张，断言，明言（）

avouch [] v./n.断言，声言，主张，承认（）

manifesto [] n.宣言，声明（）

claim [] n.要求，要求权，断定v.要求，请求，主张（）
...
bolster [] n.枕垫v.支持，鼓励（a long pillow or cushion; a structural part designed to eliminate friction or provide support or bearing; to support with or as if with a bolster: reinforce）
...
appreciable [] adj.明显的，重要的（capable of being perceived or measured: no appreciable difference）

consequential [] adj.产生后果的，重要的（）

epistle [] n.（长而重要的）书信（a formal or elegant letter）

imponderable [] adj.（重要性）无法衡量的（）

preponderate [] v.（数量上，重要性上）压倒，超过（）
...
down-to-earth ['dauntə'ə:θ] adj.实际的（1. practical: down-to-earth traveling tips; 2. unpretentious: surprised to find the movie star so down-to-earth）

know-how [] n.实际知识，技术秘诀，诀窍（knowledge of how to do something smoothly and efficiently: expertise）
...
interloper [] n.（非法）闯入者，干涉（他人之事）者（）

pushy [] adj.有精力的，富有进取心的，爱干涉的（）
...
portray [] v.描绘，描写，描写的肖像（）

delimit [] v.定界，划界（）

demarcate [] v.划分，划界（）

underscore [] v.划线于下n 底线（）
...
gentility [dʒɛn'tɪləti] n.假充上流，假装文雅; 假派头（）

factitious [fækˈtɪʃəs] adj.人为的，不真实的（）